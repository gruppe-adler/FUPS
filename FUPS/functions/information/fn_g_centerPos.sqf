/*
	...
	Returns the groups center position. Will be calculated only one time per FUPS_ai_oefClockPulse for performance reasons.
...
if (_clockPulse != FUPS_ai_oefClockPulse || !(vehicle leader _group isKindOf "Man")) then {
